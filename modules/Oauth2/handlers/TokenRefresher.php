        ...
        if ($db->num_rows($rs)) {
            ...
            if (isset($tokens['refresh_token'])) {
                ...
                if (stripos($record["server"], "smtp.gmail.com") !== false) {
                    $svc = "Google";
                } else if (stripos($record["server"], "smtp.office365.com") !== false) { 
                    $svc = "Office365";
                } else {
					return;
				}
                ...
                try {
                    ...
                    $db->pquery("UPDATE vtiger_systems SET server_password=?, smtp_auth_expireson=? WHERE id=?", 
                        array($newpassword, $newexpireson, $record['id']), true);
