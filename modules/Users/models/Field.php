...
/***********************  27 Jul 2018 change  for accessible users field  **********************/
		}else if($this->get('uitype') == 901){
		    return 'AccessibleUserandGroups';
		}else if($this->get('uitype') == 29001){ // Omniver : Changes for group information 2017-02-13
            return 'MyGroups';
        }

/***********************  27 Jul 2018 change  for accessible users field END  **********************/
	...
	public function isAjaxEditable() {
	    if(!$this->isEditable() || $this->get('uitype') == 105 || $this->get('uitype') == 106 || $this->get('uitype') == 98 || $this->get('uitype') == 101 || $this->getName() == 'appointment_url'
	        || $this->get('uitype') == 29001 || $this->get('uitype') == 901 || $this->get('uitype') == 28) {
			return false;
		}
		return true;
	}
	...
	function getValidator() {
	    ...
	    switch($fieldName) {
	        case 'user_logo':	$funcName = array('name' => 'check_file_type',
	        'params' => array('image/jpeg|image/png|image/jpg'));
	        array_push($validator, $funcName);
	        break;
	        case 'imagename':	$funcName = array('name' => 'check_file_type',
	        'params' => array('image/jpeg|image/png|image/jpg'));
	        array_push($validator, $funcName);
	        break;
